 ...
 * 
 * The first error that i fixed was the (1-x) needed to be changed to (100-x), since the former expression would result in a negative number.
 Once i changed it to (100-x), I also needed to add a set of parenthases around the 100-x, because if no parenthases are added, the the x value
 would be divided by 100 before the x value would be subtracted by 100.
 * 
 * 
 */
